...
program
    ...
    .option('--quiet', 'minimal output with reduced verbosity (20 elements max)')
    ...
    .option('--use-tmp', 'use temporary directory for output files (legacy behavior)')
    .option('--user-agent <ua string>', 'specify user agent string')
    .option('--user-data-dir <path>', 'path to the user data directory. If not specified, a temporary directory will be created.')
    .option('--verbose', 'detailed output with increased verbosity (150 elements max)')
    .option('--verbosity-level <level>', 'numeric verbosity level (1-5)', parseInt)
